(module
  ...
  (import "rust" "sum" (func $main.sum (type 1)))
      ...
      block  ;; label = @2
        block  ;; label = @3
          block  ;; label = @4
                      ...
                      block  ;; label = @10
                        block  ;; label = @11
                          block  ;; label = @12
                            ...
                            block  ;; label = @13
                              ...
                              i32.const 0
                              local.get 6
                              i32.store offset=75052
                              br 12 (;@1;)
                            end
                            i32.const 0
                            i32.load offset=75048
                            local.tee 9
                            i32.eqz
                            br_if 1 (;@11;)
                            local.get 9
                        ...
                        block  ;; label = @11
                          block  ;; label = @12
                            ...
                            br_if 0 (;@12;)
                            i32.const 0
                            i32.load offset=75524
                            local.set 4
                            br 1 (;@11;)
                          end
                          i32.const 0
                          i64.const -1
                          i64.store offset=75528 align=4
                          i32.const 0
                          i64.const 281474976776192
                          i64.store offset=75520 align=4
                          i32.const 0
                          local.get 1
                          i32.const 12
                          i32.add
                        ...
                        block  ;; label = @11
                          i32.const 0
                          i32.load offset=75484
                          local.tee 0
                          i32.eqz
                          br_if 0 (;@11;)
                          block  ;; label = @12
                            i32.const 0
                            i32.load offset=75476
                            local.tee 4
                            local.get 8
                            i32.add
                            local.tee 6
            ...
            i32.add
            local.tee 0
            i32.store offset=75476
            block  ;; label = @5
              local.get 0
              i32.const 0
              i32.load offset=75480
              i32.le_u
              br_if 0 (;@5;)
              i32.const 0
              local.get 0
              i32.store offset=75480
            end
            block  ;; label = @5
              block  ;; label = @6
                block  ;; label = @7
              ...
              block  ;; label = @6
                block  ;; label = @7
                  block  ;; label = @8
                    ...
                    i32.add
                    i32.const 0
                    i64.load offset=75500 align=4
                    i64.store align=4
                    local.get 8
                    i32.const 0
                    i64.load offset=75492 align=4
                    i64.store offset=8 align=4
                    i32.const 0
                    local.get 8
                    i32.const 8
                    i32.add
                    i32.store offset=75500
                    i32.const 0
                    local.get 2
                    i32.store offset=75496
                    i32.const 0
    ...
    block  ;; label = @1
      block  ;; label = @2
        block  ;; label = @3
          ...
          i32.const 0
          local.get 1
          i32.store offset=73636
          i32.const 0
          local.get 4
          i32.store offset=73632
          loop  ;; label = @4
            local.get 1
            local.get 3
            i32.eq
        ...
        i32.store offset=75680
        i32.const 0
        i32.const 0
        i64.load offset=73632
        i64.store offset=75672
        local.get 0
        i32.const 16
        i32.add
        global.set 0
  ...
  (func $strconv.appendQuotedRuneWith (type 8) (param i32 i32 i32 i32)
    ...
    i32.add
    global.set 0)
  (func $_*fmt.pp_.argNumber (type 12) (param i32 i32 i32 i32 i32 i32)
    (local i32 i32 i32 i32 i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func $_*fmt.pp_.printValue (type 12) (param i32 i32 i32 i32 i32 i32)
    ...
    call $runtime.nilPanic
    unreachable)
  (func $_*fmt.pp_.doPrintf (type 8) (param i32 i32 i32 i32)
    ...
    call $runtime.nilPanic
    unreachable)
  (func $fmt.intFromArg (type 6) (param i32 i32 i32)
